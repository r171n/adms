...
function edit(id) {
	...
	$.ajax({
		url: "./get_data_mata_pelajaran_edit/" + id,
		type: "GET",
		dataType: "JSON",
		success: function (data) {
			$('[name="mata_pelajaran_id"]').val(data.mata_pelajaran_id);
			$('[name="mata_pelajaran_nama"]').val(data.mata_pelajaran_nama);
			$('[name="mata_pelajaran_kode"]').val(data.mata_pelajaran_kode);
			$('[name="mata_pelajaran_kkm"]').val(data.mata_pelajaran_kkm);
			$('[name="tingkat_id"]').val(data.mata_pelajaran_tingkat_id).change();
			$("#modal").modal("show"); // show bootstrap modal when complete loaded
			$(".modal-title").text("Edit " + data.mata_pelajaran_nama + " " + data.mata_pelajaran_kode); // Set title to Bootstrap modal title
		},
		error: function (jqXHR, textStatus, errorThrown) {
